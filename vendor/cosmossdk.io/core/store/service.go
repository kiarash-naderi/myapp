...
// KVStoreServiceImpl is a concrete implementation of the KVStoreService interface.
type KVStoreServiceImpl struct{}

// Name implements types.StoreKey.
func (k *KVStoreServiceImpl) Name() string {
    panic("unimplemented")
}

// String implements types.StoreKey.
func (k *KVStoreServiceImpl) String() string {
    panic("unimplemented")
}
